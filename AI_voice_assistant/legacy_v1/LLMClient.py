...
tools = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Set a reminder or an alarm for the user. (Alarms and reminders are the exact same thing in this system).",
            "parameters": {
                "type": "object",
                "properties": {
                    "day": {"type": "integer"},
    ...
    },
    {
        ...
        "function": {
            "name": "list_reminders",
            "description": "List all active reminders and alarms including their unique IDs. (Alarms and reminders are the exact same thing in this system).",
            "parameters": {
                "type": "object",
                "properties": {},
                "required": []
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Cancel and delete an active reminder or alarm using its unique ID. (Alarms and reminders are the exact same thing in this system).",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    for tool_call in tool_calls:
        ...
        try:
            if function_name == "get_weather_data":
                ...
                tool_response = APIManagerMain.list_reminders(**function_args)
            elif function_name == "delete_reminder":
                tool_response = APIManagerMain.delete_reminder(**function_args)
...
def askLLM(prompt, model="qwen2.5-1.5b-instruct", use_tools=True):
    """
    Query Local LLM.
    """
    if not client:
